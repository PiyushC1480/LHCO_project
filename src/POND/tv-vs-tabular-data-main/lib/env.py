...
OPENML_CHECKPOINT = CHECKPOINT / 'openml'
CUSTOM_CHECKPOINT = CHECKPOINT / 'custom'

FINETUNE_BIN_DATA = PROJ / 'finetune-bin'
FINETUNE_REG_DATA = PROJ / 'finetune-reg'
FINETUNE_MUL_DATA = PROJ / 'finetune-mul'
FINETUNE_OPENML_DATA = PROJ / 'finetune-openml'
FINETUNE_CUSTOM_DATA = PROJ / 'finetune-custom'
