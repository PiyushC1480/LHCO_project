...
def get_training_args():
    ...
    args.output = f'{args.output}/{args.task}-{args.reduce_data}/ftt/{args.dataset}'
...
val_batch_size = 64
if args.task == 'openml' and args.dataset in ['4134', '40978']:
...
def objective(trial):
    ...
    cfg_model = {
        ...
        'd_out': d_out,
        'cat_cardinalities': dataset.get_category_sizes('all'),
        **cfg_model
    }
